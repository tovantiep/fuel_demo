        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar py-4">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <?= Html::anchor('users/index', 'Users', ['class' => 'nav-link active']) ?>
                    </li>
                </ul>
            </div>
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <?= Html::anchor('users/index', 'Posts', ['class' => 'nav-link active']) ?>
                    </li>
                </ul>
            </div>
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <?= Html::anchor('users/index', 'Categories', ['class' => 'nav-link active']) ?>
                    </li>
                </ul>
            </div>
        </nav>
