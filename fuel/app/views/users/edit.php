            ...
            <div class="card signup-card shadow-lg">
                <div class="card-body">
                    ...
                    <form id="editUserForm" method="post" autocomplete="off">
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label"><?= \Lang::get('app.password') ?> <small class="text-muted">(<?= \Lang::get('app.leave_blank') ?>)</small></label>
                            <input type="password" class="form-control" id="password" name="password" minlength="6">
                        </div>
                        <button type="submit" class="btn btn-primary w-100 mt-2"><?= \Lang::get('app.update') ?></button>
                    </form>
                </div>
            </div>
        </div>
